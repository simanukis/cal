"""
Django settings for djangoCalApp project.
...
SECRET_KEY = 'django-insecure-cd2q&b1*v_1t4iq#iopu+p9#_&7#)z3=rzyzgpm*5w#!l$4*wt'
...
ROOT_URLCONF = 'djangoCalApp.urls'
...
WSGI_APPLICATION = 'djangoCalApp.wsgi.application'
